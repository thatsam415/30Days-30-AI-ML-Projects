...
| 27 | Customer Segmentation with RFM + K-Means | Unsupervised segmentation of customers based on RFM patterns using K-Means and RFM analytics | 🛍️ Unsupervised Learning / Customer Analytics |
| 28 | Sentiment Analysis of Amazon Product Reviews | Classifying the sentiment of Amazon product reviews using TF-IDF representations with Multinomial Naive Bayes classifier | ✨ NLP / Text Classification |
| 29 | Movie Box Office Revenue Prediction | Predicting box office revenue using movie metadata with regression models | 🎬 Regression / Feature Engineering |
| 30 | Fake News Detection Using TF-IDF + SVM | Identifying real vs. fake news articles through TF-IDF feature extraction and Support Vector Machine classification | 📰 NLP / Text Classification |
